...
const ICONS = {
  ...
  // 마우스 도구 표시. cursor는 화살표(고르기), move는 사방 화살표(화면 옮기기)다.
  // 손 모양은 선으로 그리면 무엇인지 알아보기 어려워 사방 화살표를 쓴다.
  cursor: ['M5 3l5.6 16.8 2.3-6 6-2.3z'],
  move: ['M5 9l-3 3 3 3', 'M9 5l3-3 3 3', 'M15 19l-3 3-3-3', 'M19 9l3 3-3 3', 'M2 12h20', 'M12 2v20'],
  // 사진(그림 파일). 액자 안에 산과 해가 있는 흔한 그림 아이콘이다.
  image: ['M3 5h18v14H3z', 'M3 16l5-5 4 4 3-3 6 6', 'M8.5 9.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z'],
